...
func ToSqlWithAND(parts ...Sqlizer) (sqlStr string, args []interface{}, err error) {
	return toSql(" AND ", parts...)
}

func ToSqlWithOR(parts ...Sqlizer) (sqlStr string, args []interface{}, err error) {
	return toSql(" OR ", parts...)
}

func ToSqlWith(sep string) func(parts ...Sqlizer) (sqlStr string, args []interface{}, err error) {
	return func(parts ...Sqlizer) (sqlStr string, args []interface{}, err error) {
		return toSql(sep, parts...)
	}
}
